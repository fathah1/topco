...
function noteProperties() {
    return {
      toolbar: [
        ['style', ['fontname', 'style', 'fontsize', 'bold', 'italic', 'underline', 'strikethrough']],
      ...
      fontSizes: ['8', '9', '10', '11', '12', '14', '16', '18', '24', '36', '48', '64', '72', '96'],
      fontNames: ['Gotham', 'DIN Pro', 'Montserrat', 'Arial', 'Times New Roman'],
      fontNamesIgnoreCheck: ['Gotham', 'DIN Pro', 'Montserrat'],  
      styleTags: [
        'p',
  ...
  $(document).on("htmx:afterSettle", function (e) {
    ...
    $(`#${targetId} [data-summernote]`).summernote(noteProperties());
  });

  $(document).ready(function () {
    $(`[data-summernote]`).summernote(noteProperties());
  });


  $(document).on("htmx:afterRequest", function (e) {
    element = $(e.detail.target)
    element.find("[data-summernote]").summernote(noteProperties());
});
