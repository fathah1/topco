...
urlpatterns = [
    ...
    path("annual-leave-tracking-view/",   views.annual_leave_tracking_view, name="annual-leave-tracking-view"),
    ...
    path("assigned-leave-bulk-delete",views.leave_assign_bulk_delete,name="assigned-leave-bulk-delete",),
    path("assign-leave-type-excel",views.assign_leave_type_excel,name="assign-leave-type-excel",),
    ...
    path("get-restrict-job-positions",views.get_job_positions,name="get-restrict-job-positions",),
    ...
    path("restrict-days-bulk-delete",views.restrict_days_bulk_delete,name="restrict-days-bulk-delete",),
    path("restrict-day-select-filter",views.restrict_day_select_filter,name="restrict-day-select-filter",),
    ...
    path("user-request-cancel/<int:id>",views.user_leave_cancel,name="user-request-cancel",),
